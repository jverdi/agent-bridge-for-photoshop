---
title: "PS Agent Bridge overview"
description: "Architecture and responsibilities for the CLI, bridge daemon, UXP plugin, and MCP server."
---

PS Agent Bridge is a local automation stack for Photoshop. It gives agents and humans a stable command surface, operation payload schema, and runtime bridge between CLI workflows and Photoshop UXP APIs.
